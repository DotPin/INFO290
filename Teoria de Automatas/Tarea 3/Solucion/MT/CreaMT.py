...
def llenarTransiciones(estados, alfabeto, ent): # lleno la matriz de transiciones luego de validarla
    ...
    transVacia = [["**************" for x in xrange(m)] for x in xrange(n)] #Se reparo error de dimensión por indices
...
def obtEstadosAlfabeto(entrada0):  # filtro los estados y el elfabeto de la entrada
