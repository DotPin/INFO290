...
def obtEstadosAlfabeto(entrada0, final):  # filtro los estados y el elfabeto de la entrada
    ...
    if final in estados:
        a = estados.index(final)
        #print "estados:", estados
        estados[a], estados[len(estados)-1] = estados[len(estados)-1], estados[a]
        #print "estados con estado final al ultimo", estados
    if 'B' in alfabeto:
        a = alfabeto.index('B')
        #print "alfabeto:", alfabeto
        alfabeto[a], alfabeto[len(alfabeto)-1] = alfabeto[len(alfabeto)-1], alfabeto[a]
        #print "alfabeto con B al ultimo", alfabeto
    print ""
