...
-En el panel n1 se muestra la imagen original junto con los botones
para la ejecucion de los filtros en el panel n°2.
...
-La imagen si no abre es por la ruta dada para el BufferedImage de la clase Filtro
