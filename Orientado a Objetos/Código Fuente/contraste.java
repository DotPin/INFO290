...
public class contraste extends Canvas {
    ...
    public BufferedImage activar(BufferedImage intensidad,int ingreso){
        ...
        try
        {
            ...
            for(int i = 0; i < totalDePixeles; i++){
                ...
                int r = ((0xff & (p>>16)) * ingreso/100);
                int v = ((0xff & (p>>8)) * ingreso/100);
                int az = ((0xff & p) * ingreso/100);
                                
                rojo = (0xff & (p>>16)) + r; //Desplaza el entero p 16 bits a la derecha yaplica la operacion AND a los primeros 8 bits
                verde = (0xff & (p>>8)) + v; //Desplaza el entero p 8 bits a la derecha yaplica la operacion AND a los siguientes 8 bits
                azul = (0xff & p) + az; //Aplica la operacion AND a los siguientes 8bits
